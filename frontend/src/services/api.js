...
export const adminAPI = {
    ...
    getUserMonitors: (id, page = 1, limit = 5) => adminInstance.get(`/admin/users/${id}/monitors`, { params: { page, limit } }),
    getUserIncidents: (id, page = 1, limit = 5) => adminInstance.get(`/admin/users/${id}/incidents`, { params: { page, limit } }),
