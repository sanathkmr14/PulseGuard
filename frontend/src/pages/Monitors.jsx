        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2.5">
                    ...
                    {/* Filter Tabs and Mobile Add Button */}
                    <div className="flex items-center justify-between gap-2 w-full sm:w-auto">
                        <div className="flex bg-[#12121a] p-0.5 rounded-lg border border-gray-800 overflow-x-auto flex-1 sm:flex-initial max-w-full">
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-all flex items-center gap-1.5 shrink-0 cursor-pointer whitespace-nowrap ${
                                        filter === f.id
