...
const AdminLogin = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-900 flex items-center justify-center relative overflow-hidden font-inter">
            {/* Background Effects */}
            ...
            <div className="relative z-10 w-full max-w-md p-8">
                ...
                <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
                    {error && (
                        <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 text-red-500 rounded-lg text-sm flex items-center">
