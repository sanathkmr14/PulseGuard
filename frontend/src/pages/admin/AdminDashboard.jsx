                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 w-full md:w-auto">
                            ...
                            <div className="relative w-full sm:w-64 sm:ml-4">
                                <div className="relative">
                                    ...
                                    <input
                                        type="text"
                                        className="w-full bg-slate-900/50 border border-slate-700 rounded-lg pl-10 pr-8 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all"
                                ...
                                {isDropdownOpen && (
                                    <div className="absolute mt-1 w-full bg-slate-800 border border-slate-700 rounded-lg shadow-xl max-h-60 overflow-y-auto z-50 custom-scrollbar">
                                        {users.length > 0 ? (
                                            <>
                                                <div
                                                    className={`px-4 py-2 text-xs cursor-pointer hover:bg-slate-700/50 transition-colors ${!selectedUser ? 'bg-blue-500/10 text-blue-400' : 'text-slate-300'}`}
                                                    onClick={clearUserSelection}
                                                >
                                                    Global (All Users)
                                                </div>
                                                {users.map(user => (
                                                    <div
                                                        key={user._id}
                                                        className={`px-4 py-2 text-xs cursor-pointer hover:bg-slate-700/50 transition-colors flex justify-between items-center ${selectedUser === user._id ? 'bg-blue-500/10 text-blue-400' : 'text-slate-300'}`}
